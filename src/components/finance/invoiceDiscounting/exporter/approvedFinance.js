                    ...
                    <main role="main" className={"ml-sm-auto col-lg-10 expanded-right"} id="app-main-div">
                        ...
                        <div className='mt-1'>
                            ...
                            <NewTable disableAction={true}
                                ...
                                {
                                    name: "Purchase Order No.", filter: true
                                },
                                {
                                    name: "Invoice No.", filter: true
                                },
                                {
                                    name: "Invoice Due Date", filter: true
                                },
                                {
                                    name: "Finance Credit Days", filter: true
                                },
                                {
